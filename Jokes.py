...
def get_topics():
    selected_topics = int(input("Enter the topic number: "))
    if selected_topics == 0:
        exit()
    elif selected_topics > len(topics):
        print("Invalid topic number. Please try again.")
        return get_topics()
    elif selected_topics == 1:
        return jokes(Technology_Jokes), selected_topics
    elif selected_topics == 2:
        return jokes(Programming_Jokes), selected_topics
    elif selected_topics == 3:
        return jokes(Math_Jokes), selected_topics
    elif selected_topics == 4:
        return jokes(Science_Jokes), selected_topics
    elif selected_topics == 5:
        return jokes(Miscellaneous_Jokes), selected_topics
    elif selected_topics == 6:
        return jokes(General_Jokes), selected_topics
    elif selected_topics == 7:
        return jokes(Dark_Jokes), selected_topics


def jokes(top: list[str]) -> str:
...
if __name__ == "__main__":
    ...
    joke, topic_num = get_topics()
    print(f"\nHere's a joke from the topic '{topics[topic_num - 1]}':")
    print(joke)
